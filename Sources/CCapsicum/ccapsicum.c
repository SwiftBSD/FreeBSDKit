...
cap_rights_t*
ccaspsicum_cap_set(cap_rights_t* rights, ccapsicum_right_map right) {
    return cap_rights_set(rights, ccapsicum_selector(right));
}

bool
ccapsicum_right_is_set(const cap_rights_t* rights, ccapsicum_right_map right) {
    return cap_rights_is_set(rights, ccapsicum_selector(right));
}

void
ccap_rights_clear(cap_rights_t* rights, ccapsicum_right_map right) {
...
uint64_t
ccapsicum_selector(ccapsicum_right_map r)
{
    switch (r) {
